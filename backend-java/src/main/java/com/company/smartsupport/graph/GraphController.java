...
public class GraphController {
    ...
    public ApiResponse<PageResult<GraphAssetSummaryDto>> queryGraphAsset(
        ...
        return ApiResponse.success(
                ...
                graphAssetService.queryGraphAssets(projectId, graphCategoryId, entityType, relationType, sourceId, pageNo, pageSize));
    }
    ...
    public ApiResponse<Map<String, Object>> deleteGraphAsset(@PathVariable String graphId) {
        requestContext.requireIdempotencyKey();
        String projectId = requestContext.requireProjectId();
        return ApiResponse.success(requestContext.requestId(), graphAssetService.deleteGraphAsset(projectId, graphId, requestContext.actorId()));
    }
    ...
    public ApiResponse<Map<String, Object>> updateGraphAssetDraft(@PathVariable String graphId, @RequestBody Map<String, Object> body) {
        requestContext.requireIdempotencyKey();
        String projectId = requestContext.requireProjectId();
        return ApiResponse.success(requestContext.requestId(), graphAssetService.updateGraphDraft(projectId, graphId, body, requestContext.actorId()));
    }
    ...
    public ApiResponse<Map<String, Object>> publishOrRollbackGraph(@PathVariable String graphId, @RequestBody Map<String, Object> body) {
        ...
        return ApiResponse.success(requestContext.requestId(), Map.of("graphId", graphId, "status", "deferred", "action", body.get("action")));
    }
}
